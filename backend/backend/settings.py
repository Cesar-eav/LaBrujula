...
SECRET_KEY = 'django-insecure-z&0hy50lrl2v2(4tjdp&sp73s^*lb=$18rpz+h$0sgutrv@44#'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'labrujula5.sqlite3',
    }
}
...
# CKEDITOR_5_FILE_STORAGE = 'path.to.your.storage'
